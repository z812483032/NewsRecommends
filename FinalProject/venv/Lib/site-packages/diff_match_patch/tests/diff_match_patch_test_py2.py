...
class DiffTest(DiffMatchPatchTest):
    ...
    def testDiffDelta(self):
        ...
        diffs = [
            (self.dmp.DIFF_EQUAL, u"\u0680 \x00 \t %"),
            (self.dmp.DIFF_DELETE, u"\u0681 \x01 \n ^"),
    ...
    def testDiffBisect(self):
        ...
        self.assertEquals(
            ...
            self.dmp.diff_bisect(a, b, sys.maxint),
        )
    ...
    def testDiffMain(self):
        ...
        self.assertEquals(
            [
                (self.dmp.DIFF_DELETE, "a"),
                (self.dmp.DIFF_INSERT, u"\u0680"),
                (self.dmp.DIFF_EQUAL, "x"),
                (self.dmp.DIFF_DELETE, "\t"),
                (self.dmp.DIFF_INSERT, "\x00"),
            ],
            self.dmp.diff_main("ax\t", u"\u0680x\x00", False),
        )
